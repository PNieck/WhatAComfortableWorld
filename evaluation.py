...
def main(argv):
    ...
    if args.save_output is not None:
        ...
        output["Coverage"] = {
            "correctness rate": cov_rate.correctness_rate(),
            "avg coverage rate": cov_rate.avg_coverage_rate(),
            "avg overfilling rate": cov_rate.avg_overfilling_rate()
        }

        output["Room overlapping"] = {
            "correctness rate": room_overlap_rate.correctness_rate(),
            "avg overlapping rate": room_overlap_rate.avg_overlapping_rate()
        }
